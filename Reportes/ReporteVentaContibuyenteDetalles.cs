...
namespace Reportes
{
    public class ReporteVentaContibuyenteDetalles
    {
        ...
        public ReporteVentaContibuyenteDetalles(string fecha, int desde, int hasta, decimal local_gravadas, decimal exportacion_gravadas, decimal exentas, decimal totales, string fex)
        {
            this.fecha = fecha;
            this.desde = desde;
            this.hasta = hasta;
